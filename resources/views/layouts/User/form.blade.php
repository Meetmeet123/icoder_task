                        ...
                        <form action="{{$user ?  route( 'users.update',['user'=>$user->id]) : route('users.store') }}" method="POST">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="number">Contact Number<span class="small text-danger">*</span></label>
                                            <input type="tel" id="number" class="form-control" name="number" placeholder="+91 1234567890" value="{{ isset($user->number) ? $user->number : @old('number')}}">
                                            @error('number')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
